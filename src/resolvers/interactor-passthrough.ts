...
export async function resolveInteractorWrite(
  ...
  try {
    ...
    return {
      shape,
      body: { ok: true, id, visibility, logged: false, log_error: err instanceof Error ? err.message : String(err), source: "interactor-passthrough-resolver", category: "interactor" },
    };
  }
